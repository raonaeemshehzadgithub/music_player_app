...
class ArtistsContentResolver(context: Context, private  val artistId: Long? = null, private  val name: String? = null) :
    ...
    override fun convertCursorToItem(cursor: Cursor) = Artist(
        ...
        albumId = cursor.getLongValue(MediaStore.Audio.Albums._ID)
    )
}